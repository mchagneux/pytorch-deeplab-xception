...
class SURFSegmentation(Dataset):
    NUM_CLASSES = 4

    def __init__(self, args=None, base_dir=Path.db_root_dir('surfrider'), split="train"):
        super().__init__()

        ann_file = os.path.join(base_dir , 'annotations')
        ann_file += "_" + split + ".json"
        ids_file = os.path.join(base_dir, 'annotations_{}_ids.pth'.format(split))
...
if __name__ == "__main__":
    ...
    coco_val = SURFSegmentation(args,split='val')
